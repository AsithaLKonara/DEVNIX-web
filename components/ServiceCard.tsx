...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, icon, href }) => {
  return (
    <div className="p-6 sm:p-10 glass rounded-[32px] sm:rounded-[40px] border border-white/5 hover:border-primary/30 hover:shadow-[0_0_50px_rgba(123,164,208,0.15)] transition-all duration-500 group relative overflow-hidden">
